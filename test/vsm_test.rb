...
class VsmTest < ActiveSupport::TestCase
	...
	def setup
		@vsm = Vsm.new(file_name: "MyVSM",
					   ...
					   inventory2: 1783, processB: "Label Containers", resourceB: "By delivery location", dataB1: "total cycle: 30 seconds", dataB2: "NVA: 30 seconds", dataB3: "C/O: 10 min",
					   inventory3: 1783, processC: "Place & Load", resourceC: "Place product by location and load food into bags", dataC1: "total cycle: 210 seconds", dataC2: "NVA: 210 seconds", dataC3: "C/O: 30 min",
					   inventory4: 1783, processD: "Shipping", resourceD: "Pack bags into red cooler bags and load truck", dataD1: "Truck leave by 9AM", dataD2: "N/A", dataD3: "N/A",
